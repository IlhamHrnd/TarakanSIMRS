...
public partial class ItemTransaction
{
    ...
    public string DownPaymentReferenceNo { get; set; }

    public string SrdownPaymentType { get; set; }

    public string SradjustmentType { get; set; }

    public string SrdistributionType { get; set; }

    public string SrpurchaseReturnType { get; set; }
