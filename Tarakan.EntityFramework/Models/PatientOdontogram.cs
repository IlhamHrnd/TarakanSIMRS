...
public partial class PatientOdontogram
{
    ...
    public DateTime? OdontogramDateTime { get; set; }
    ...
    public string? T1151notes { get; set; }

    public string? T1252notes { get; set; }

    public string? T1353notes { get; set; }

    public string? T1454notes { get; set; }

    public string? T1555notes { get; set; }

    public string? T16notes { get; set; }

    public string? T17notes { get; set; }

    public string? T18notes { get; set; }

    public string? T6121notes { get; set; }

    public string? T6222notes { get; set; }

    public string? T6323notes { get; set; }

    public string? T6424notes { get; set; }

    public string? T6525notes { get; set; }

    public string? T26notes { get; set; }

    public string? T27notes { get; set; }

    public string? T28notes { get; set; }

    public string? T48notes { get; set; }

    public string? T47notes { get; set; }

    public string? T46notes { get; set; }

    public string? T4585notes { get; set; }

    public string? T4484notes { get; set; }

    public string? T4383notes { get; set; }

    public string? T4282notes { get; set; }

    public string? T4181notes { get; set; }

    public string? T38notes { get; set; }

    public string? T37notes { get; set; }

    public string? T36notes { get; set; }

    public string? T7535notes { get; set; }

    public string? T7434notes { get; set; }

    public string? T7333notes { get; set; }

    public string? T7232notes { get; set; }

    public string? T7131notes { get; set; }
